...
"""\
Script that performs ms-clean reconstruction on some dataset. This does the same as the ip_l1.py script but uses a different strategy to obtain the regularization parameter using lambda_max
Example execution: python ip_msclean_mp.py <config_filename>
""" 
