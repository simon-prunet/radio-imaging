#!/bin/bash
#SBATCH --job-name=sgralarge_l1bda
#SBATCH --partition=cpu_p1
#SBATCH --time=20:00:00
#SBATCH --ntasks=1
#SBATCH --ntasks-per-node=1
#SBATCH --output=sgralarge_l1bda.out
#SBATCH --error=sgralarge_l1bda.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
python ip_l1_mp.py configs/sgra_multipartition_bda.config
