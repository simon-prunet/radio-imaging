#!/bin/bash
#SBATCH --job-name=sgrcpl1bda
#SBATCH --partition=cpu_p1
#SBATCH --time=01:00:00
#SBATCH --ntasks=6
#SBATCH --ntasks-per-node=1
#SBATCH --output=sgrcpl1bda.out
#SBATCH --error=sgrcpl1bda.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
mpirun -np 6 python ip_l1_p_multipartition.py configs/sgrc_multipartition_bda.config
