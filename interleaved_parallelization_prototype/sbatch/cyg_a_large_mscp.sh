#!/bin/bash
#SBATCH --job-name=cygalarge_mscp
#SBATCH --partition=cpu_p1
#SBATCH --time=20:00:00
#SBATCH --ntasks=3
#SBATCH --ntasks-per-node=1
#SBATCH --output=cygalarge_mscp.out
#SBATCH --error=cygalarge_mscp.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
mpirun -np 3 python ip_msclean_p.py configs/cygalarge.config