#!/bin/bash
#SBATCH --job-name=sgrapl1
#SBATCH --partition=cpu_p1
#SBATCH --time=01:00:00
#SBATCH --ntasks=6
#SBATCH --ntasks-per-node=1
#SBATCH --output=sgrapl1.out
#SBATCH --error=sgrapl1.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
mpirun -np 6 python ip_l1_p_multipartition.py configs/sgra_multipartition_jz.config
