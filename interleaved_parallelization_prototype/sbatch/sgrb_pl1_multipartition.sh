#!/bin/bash
#SBATCH --job-name=sgrbpl1
#SBATCH --partition=cpu_p1
#SBATCH --time=01:00:00
#SBATCH --ntasks=6
#SBATCH --ntasks-per-node=1
#SBATCH --output=sgrbpl1.out
#SBATCH --error=sgrbpl1.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
mpirun -np 6 python ip_l1_p_multipartition.py configs/sgrb_multipartition_jz.config
