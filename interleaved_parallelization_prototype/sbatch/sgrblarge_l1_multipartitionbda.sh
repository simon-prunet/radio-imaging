#!/bin/bash
#SBATCH --job-name=sgrblarge_l1bda
#SBATCH --partition=cpu_p1
#SBATCH --time=20:00:00
#SBATCH --ntasks=1
#SBATCH --ntasks-per-node=1
#SBATCH --output=sgrblarge_l1bda.out
#SBATCH --error=sgrblarge_l1bda.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
python ip_l1_mp.py configs/sgrb_multipartition_bda.config
