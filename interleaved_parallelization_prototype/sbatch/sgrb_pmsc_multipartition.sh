#!/bin/bash
#SBATCH --job-name=sgrbpmsc
#SBATCH --partition=cpu_p1
#SBATCH --time=01:00:00
#SBATCH --ntasks=6
#SBATCH --ntasks-per-node=1
#SBATCH --output=sgrbpmsc.out
#SBATCH --error=sgrbpmsc.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
mpirun -np 6 python ip_msclean_p_multipartition.py configs/sgrb_multipartition_jz.config
