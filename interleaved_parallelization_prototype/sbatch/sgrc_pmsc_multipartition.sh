#!/bin/bash
#SBATCH --job-name=sgrcpmsc
#SBATCH --partition=cpu_p1
#SBATCH --time=01:00:00
#SBATCH --ntasks=6
#SBATCH --ntasks-per-node=1
#SBATCH --output=sgrcpmsc.out
#SBATCH --error=sgrcpmsc.err 
#SBATCH --exclusive
#SBATCH -A klu@cpu
...
mpirun -np 6 python ip_msclean_p_multipartition.py configs/sgrc_multipartition_jz.config
