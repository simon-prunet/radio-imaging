...
"""\
Helper script used to taper the edges of an image. Cubic interpolation is used for now but should be updated to use a prolate spheroidal
or primary beams instead
""" 
