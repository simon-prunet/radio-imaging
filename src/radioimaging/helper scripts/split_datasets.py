...
"""\
Helper script used to split visibilities by their uv distance to zero. This is done in a separate callable script rather than
callable functions because there is a crash for some reason.
""" 
