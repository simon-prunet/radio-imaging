...
#this function assumes that vis already contains the relevant weights, so as to not recalculate the weights every major cycle
...
#computes psf for some visibility positions and weights
...
#calculates weights for visibilities
